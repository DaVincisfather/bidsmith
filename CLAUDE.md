...
- `BIDSMITH_FOREIGN_TEMPLATES` är AV som default sedan 2026-08-03 (MD-first-beslutet:
  Markdown-exporten är den formella leveransen, PPTX-motorn är experimentell yta;
